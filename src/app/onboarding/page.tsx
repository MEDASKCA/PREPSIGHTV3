...
export default function OnboardingPage() {
  ...
  return (
    <div className="onboarding-stage min-h-screen flex flex-col overflow-hidden">
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 pb-28 pt-8 sm:pt-10 lg:pt-10">
        <div className="onboarding-panel w-full max-w-md" key={animKey}>
          {step === 1 && (
          ...
          {step === 2 && (
            <div className="animate-step-in">
              ...
              <p className="text-sm text-[#64748b] mb-6 line-reveal" style={{ animationDelay: "420ms" }}>
              ...
              >
                ...
                <p className="mt-2 text-[13px] leading-5 text-[#94a3b8] lg:text-xs">
                  {membershipHint}
                </p>
              </div>
            </div>
            ...
            <div className="animate-step-in">
              ...
              <div className="space-y-3">
                <input
                  ...
                  autoFocus
                />
                <p className="text-[13px] text-[#94a3b8] lg:text-xs">
              ...
              {departments.length > 0 && (
                <div className="mt-5 space-y-3">
                  {departments.map((department) => (
                    <div key={department} className="rounded-2xl border border-[#E2E8F0] bg-white px-4 py-3">
                      <p className="text-sm font-semibold text-[#3F4752]">{department}</p>
                  ...
                  <div className="space-y-5">
                    {specialtyGroups.map((group, groupIndex) => (
                      <section key={group.department}>
                        ...
                        >
                          <div>
                            <p className="text-[15px] font-semibold text-[#243B53]">
                              {group.settingLabel}
                            </p>
                          </div>
                          {specialtyGroups.length > 1 && (
          ...
          {step === 7 && (
            <div className="animate-step-in">
              ...
              <p className="mb-6 text-xs leading-5 text-[#94a3b8]">
      ...
      <div className="fixed bottom-0 left-0 right-0 z-20 border-t border-white/60 bg-white/82 px-6 pb-[calc(env(safe-area-inset-bottom,0px)+16px)] pt-4 backdrop-blur-xl lg:py-4">
